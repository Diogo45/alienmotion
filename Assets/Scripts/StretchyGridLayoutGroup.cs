  ...
  public class StretchyGridLayoutGroup : LayoutGroup
  {
    ...
    private void SetCellsAlongAxis(int axis)
    {
      ...
      for (int i = 0; i < rectChildren.Count; i++)
      {
        ...
        float realsizeH = ((height - (spacing[1] * (actualCellCountY - 1))) / actualCellCountY);
        SetChildAlongAxis(rectChildren[i], 1, startOffset.y + (realsizeH + spacing[1]) * positionY, realsizeH);
